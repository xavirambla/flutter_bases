...
class MyApp extends StatelessWidget {
  ...
  Widget build (BuildContext context){
    return MaterialApp(
      debugShowCheckedModeBanner : true,   // debug text
      title : 'Material App',  
      home: HomeScreen()
      /*
      home: Scaffold(     // lienzo blanco grande y tan grande cómo la pantalla
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Flutter Demo Home Pag hola1'),
    );
  }
}
